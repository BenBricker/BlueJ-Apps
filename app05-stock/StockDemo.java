...
public class StockDemo
{
    ...
    public StockDemo(StockManager manager)
    {
        ...
        manager.addProduct(new Product(24,  "fridge", 0));
        manager.addProduct(new Product(25,  "spoon", 0));
        manager.addProduct(new Product(27,  "fork", 0));
        manager.addProduct(new Product(26,  "plate", 0));
        manager.addProduct(new Product(29,  "toaster", 0));
        manager.addProduct(new Product(28,  "laptop", 0));
        manager.addProduct(new Product(22,  "freezer", 0));
    }
